<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <footer>
  <div style="position:absolute; bottom:7%; left:17%;" id="Lbanner1">고객센터 연락처 월요일 - 금요일 : 10:00 ~ 18:00<br>
"<"매장 영업시간">"<br>
평일 10:00 ~ 18:00 &nbsp; 주말 및 공휴일 휴무 &nbsp; 점심시간_ 12:00 ~ 13:00<br>
BANK<br>
기업 078-200428-01-013 &nbsp;&nbsp; 예금주 (주)**** </div>

   <div style="position:absolute; bottom:7%; left:50%;" id="Lbanner2">회사소개 사업자 등록번호
...
COMPANY REG.NO : [651-88-00183] &nbsp; NETWORK REG.NO : 제 2019-서울종로-0106호 사업자정보확인<br>
 &nbsp; ADDRESS : 서울특별시 종로구 창경궁로 ***(혜화동) 1층 (03076)
   ...
   <div style="position:absolute; bottom:0%;" id="end">
