...
<input type="radio" name="selectsex" checked value="man" checked>남성
 ...
 <!--  <button type="button" onClick="idcheckf()" > 아이디 입력 확인 </button>  --> 
  <button type="button" onClick="idoverlapf()" > 아이디 중복 확인 </button></tr> 
  
 <!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
    <tr><td class=namecolor>
   <input type="button" id="btt11" value="아이디 ajax로 중복확인"></td>
...
<jsp:include page="../CSS/indexFooterwfloat2.jsp"></jsp:include>
